...
Процедура ОбработкаПроведения(Отказ, Режим)  
	...
	КлючеваяОперация = ПредопределенноеЗначение("Справочник.КлючевыеОперации.ПроведениеРасходаТовара");
	...
	Если ЗначениеЗаполнено(ДисконтнаяКарта) и Не ДисконтнаяКарта.Неактивна Тогда 
		Движения.Бонусы.Записывать = Истина;  
		Движение = Движения.Бонусы.ДобавитьПриход();
		Движение.Период = Дата;
		Движение.ДисконтнаяКарта = ДисконтнаяКарта;
		Движение.Сумма = СуммаПоТоварамВДокументе() *0.1;
	КонецЕсли;
