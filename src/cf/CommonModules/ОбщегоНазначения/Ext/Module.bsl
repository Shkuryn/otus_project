...
Процедура ЗаписьДКПередЗаписью(Источник, Отказ) Экспорт
	Источник.Наименование = Справочники.ДисконтныеКарты.НаименованиеКарты(Источник.Код, Источник.Владелец);
КонецПроцедуры
